...
//
// Ported from generate.py lines 77-155 (constants), 303-441 (numbers) and
// 441-495 (deterministic JSON + hashing).
//
...
export const GENERATOR = 'jltg-hide-and-seek/generate.py';
export const VERSION = '1.0.0';
export const USER_AGENT = `${GENERATOR} ${VERSION} (+https://github.com/leoherzog/jltg-hide-and-seek)`;
...
export const EVENING_WINDOW = Object.freeze(['19:00:00', '22:00:00']);
...
export const WA_KIT = 'https://ka-p.webawesome.com/kit/95e68140d1204145/webawesome@3.10.0';
export const MAPLIBRE_CSS = 'https://cdn.jsdelivr.net/npm/maplibre-gl/dist/maplibre-gl.min.css';
...
/** Every constant above, in one frozen bag, for callers that prefer `CONST.X`. */
export const CONST = Object.freeze({
  GENERATOR, VERSION, USER_AGENT,
  M_PER_MILE, M_PER_KM, QUARTER_MILE_M, HALF_MILE_M, SQM_PER_SQMI, EARTH_R_M,
  WALK_SPEED_MPS, WALK_RADIUS_M, WALK_CIRCUITY, BOARD_SLACK_S, MAX_TRANSFERS,
  DEFAULT_DEPARTURE, SERVICE_DAY_SECONDS,
  HEADWAY_WINDOW, MIDDAY_WINDOW, EVENING_WINDOW, FREQUENT_HEADWAY_MIN,
  STATION_CLUSTER_M, HUB_SNAP_M, T90_ORIGIN_STRIDE, RADAR_SAMPLE_PAIRS,
  RADAR_DEAD_HIGH, RADAR_DEAD_LOW, SEEKER_SAMPLE_CAP, SURV_FULL_UNIVERSE_MAX,
  HUB_RADIAL_MIN, HUB_SEMI_RADIAL_MIN,
...
/** Back-compat alias for the Python name. */
export const _normalise = normalise;
