 ...
 *
 * NO DOM, NO MAPLIBRE. It imports `lib/geo.js` and nothing else, so it is importable
 * from Node and testable without a browser. `render/picker.js` owns every pixel;
 * `render/landing.js` owns every string; this file owns the arithmetic.
 *
...
import { bboxIntersectsRing } from './geo.js';

/** Code-point string order. The whole file's comparator. */
